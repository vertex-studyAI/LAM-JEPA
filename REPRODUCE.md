...
Do not require serialized `.pt` files to be byte-identical across independent GitHub runners. The retained four-attempt replay lineage found exact final loss and accuracy across attempts but low-order (`~1e-6` to `1e-7`) drift in some floating-point submetrics and non-identical checkpoint bytes.
...
### Independent replay lineage

- latest workflow run: `31631032761`
- latest replay head: `6aceefa1f4afb0e01869eda2734744753965c976`
- attempts verified: `4`
- latest artifact ID: `9156974552`
- latest artifact SHA-256: `91f4aae1f5f02b7b9fae24909e34f31b2067d7325957c4d78b66dfcbe1751a49`
