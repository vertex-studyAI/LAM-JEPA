...
def evaluate_label_baselines(
    ...
    *,
    ...
    """Measure label-distribution reference accuracies for the evaluation sampler.

    These baselines do not train or execute a model. The majority baseline uses the
    sampled evaluation labels and is therefore an oracle class-frequency reference,
    not a deployable predictor. The observed-uniform and full-vocabulary values are
    expected accuracies for uniform guessing over the sampled label support and the
    configured output vocabulary respectively.
    """
