...
def main():
    p = argparse.ArgumentParser(description="Train LAM-JEPA end-to-end.")
    p.add_argument("--steps", type=int, default=200)
    p.add_argument("--batch-size", type=int, default=64)
    p.add_argument("--lr", type=float, default=3e-4)
    p.add_argument("--task", type=str, default="mixed", choices=["mixed", "parity", "modadd", "algebra", "chain"])
    p.add_argument("--seed", type=int, default=7)
    p.add_argument("--device", type=str, default="cpu")
    p.add_argument("--checkpoint-dir", type=str, default="experiments/checkpoints")
    p.add_argument("--out", type=str, default="experiments/checkpoints/final.pt")
    args = p.parse_args()
