...
def main() -> None:
    ...
    budget_fields = (
        "training_seeds", "epochs", "batch_size", "optimizer",
        "lam_jepa_learning_rate", "matched_baseline_learning_rate",
        "pretrained_baseline_learning_rate", "model_steps", "train_examples",
